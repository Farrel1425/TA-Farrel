...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-section">
            ...
            <ul class="nav">
                <li class="nav-item">
                    <a href="/dashboard-admin" class="nav-link" data-page="dashboard">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.petugas.index') }}" class="nav-link" data-page="petugas">
    ...
    <script>
        ...
        function setActiveMenu() {
            ...
            if (!activePageFound) {
                if (currentPath.includes('/petugas')) {
                    document.querySelector('[data-page="petugas"]')?.classList.add('active');
...
<style>
    ...
    * {
    ...
    /* Override Bootstrap container untuk full width layout */
    .container-fluid {
        padding: 0 !important;
        margin: 0 !important;
    ...
    /* Override untuk ikon Font Awesome yang ada */
    ...
    /* Override untuk class yang ada di template lama */
    .app-title {
        font-size: 1.8rem;
        font-weight: 600;
        margin-bottom: 20px;
